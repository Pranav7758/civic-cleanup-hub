...
type UserRole = "citizen" | "worker" | "ngo" | "scrap" | "admin";
...
const roles: RoleConfig[] = [
  ...
  },
  {
    ...
    description: "Manage pickup tasks",
  ...
  },
  {
    ...
    description: "Buy recyclables",
    dashboardRoute: "/scrap",
  },
  {
    id: "admin",
    label: "Admin",
...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    navigate(selectedRoleConfig.dashboardRoute);
  };
        ...
        <div className="w-full max-w-md">
              ...
              {roles.map((role) => (
                <button
                  ...
                  className={`
                    ...
                    ${selectedRole === role.id 
                      ? `${role.gradient} text-white shadow-lg` 
          ...
          <Card className="border-0 shadow-card">
            <CardHeader className="text-center pb-2">
              ...
              <CardDescription>
                as {selectedRoleConfig.label} • {selectedRoleConfig.description}
              </CardDescription>
            </CardHeader>
            ...
            <CardContent>
              <Tabs value={isLogin ? "login" : "signup"} className="w-full">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <Button 
                    type="submit" 
                    className={`w-full ${selectedRoleConfig.gradient} hover:opacity-90`}
                    size="lg"
                    disabled={isLoading}
                  >
